...
~~hints pop up over the board dimming the entire board and covering up some of the board. making the highlighted tiles hard to read. when we highlight a tile or tile section we should dim the other one's to make it clearer.~~ FIXED

~~clicking and dragging sometimes doesnt release properly and wards will drop after mouse is up.~~ FIXED
